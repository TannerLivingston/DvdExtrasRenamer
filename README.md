...
I wanted to make it easier to identify and rename the bonus features that I rip off my disks with [MakeMKV](https://www.makemkv.com/) for my Jellyfin server. This program makes the process much easier than manually checking the length of each extra that comes off the disk and comparing it against the list of titles found online. Maybe someone else will find it useful too.
